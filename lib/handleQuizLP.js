...
import quiz_pixel_temp from '../assets/quiz-lp-pixel-temp.html'
import dynamicLanders from '../config/dynlanders.json'

export async function handleQuizLP(context, mappings, htmlsrc) {
...
export async function handleQuizLPwPixel(context, mappings) {
  return handleQuizLP(context, mappings, quiz_pixel_temp);
}